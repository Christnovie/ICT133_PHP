...
<head>
    ...
    <!-- Icons -->
    <link href="Content/scripts/icons/general/stylesheets/general_foundicons.css" media="screen" rel="stylesheet"
          type="text/css"/>
    <link href="Content/scripts/icons/social/stylesheets/social_foundicons.css" media="screen" rel="stylesheet"
          type="text/css"/>
    <!--[if lt IE 8]>
    <link href="Content/scripts/icons/general/stylesheets/general_foundicons_ie7.css" media="screen" rel="stylesheet"
          type="text/css"/>
    <link href="Content/scripts/icons/social/stylesheets/social_foundicons_ie7.css" media="screen" rel="stylesheet"
          type="text/css"/>
    <![endif]-->
    <link rel="stylesheet" href="Content/scripts/fontawesome/css/font-awesome.min.css">
    <!--[if IE 7]>
    <link rel="stylesheet" href="Content/scripts/fontawesome/css/font-awesome-ie7.min.css">
    <![endif]-->

    <link href="Content/scripts/carousel/style.css" rel="stylesheet" type="text/css"/>
    <link href="Content/scripts/camera/css/camera.css" rel="stylesheet" type="text/css"/>
...
<script src="Content/scripts/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="Content/scripts/default.js" type="text/javascript"></script>


<script src="Content/scripts/carousel/jquery.carouFredSel-6.2.0-packed.js" type="text/javascript"></script>
...
<script src="Content/scripts/camera/scripts/camera.min.js" type="text/javascript"></script>
<script src="Content/scripts/easing/jquery.easing.1.3.js" type="text/javascript"></script>
